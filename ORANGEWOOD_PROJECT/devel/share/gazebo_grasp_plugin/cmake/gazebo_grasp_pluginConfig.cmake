...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/hardik/ORANGEWOOD_PROJECT/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /home/hardik/ORANGEWOOD_PROJECT/devel)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /home/hardik/ORANGEWOOD_PROJECT/install)
...
if(NOT "/home/hardik/ORANGEWOOD_PROJECT/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_grasp_plugin/include " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/hardik/ORANGEWOOD_PROJECT/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_grasp_plugin/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hardik/ORANGEWOOD_PROJECT/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()

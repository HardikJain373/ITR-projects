...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_world_plugin_loader_SOURCE_PREFIX /home/hardik/ORANGEWOOD_PROJECT/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_world_plugin_loader)
  set(gazebo_world_plugin_loader_DEVEL_PREFIX /home/hardik/ORANGEWOOD_PROJECT/devel)
  ...
  set(gazebo_world_plugin_loader_INSTALL_PREFIX /home/hardik/ORANGEWOOD_PROJECT/install)
...
if(NOT "/home/hardik/ORANGEWOOD_PROJECT/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_world_plugin_loader/include " STREQUAL " ")
  set(gazebo_world_plugin_loader_INCLUDE_DIRS "")
  set(_include_dirs "/home/hardik/ORANGEWOOD_PROJECT/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_world_plugin_loader/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_world_plugin_loader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hardik/ORANGEWOOD_PROJECT/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_world_plugin_loader/${idir}'.  ${_report}")
    endif()
